        ...
        <div className="w-[100%]">
          ...
          <div className="absolute md:z-20 md:bottom-0 xl:w-[70%] md:w-[100%] md:px-1 w-[50%] px-12 top-0">
            <div className="pt-24 md:absolute md:bottom-[20px] md:flex md:flex-col md:items-center md:justify-center">
              ...
              <h4 className="Subtitle--text md:flex md:items-center md:justify-center md:text-center md:text-[23px] md:h-9 md:w-[100%] md:leading-3 w-[80%] md:pt-2 pt-6">
                What is your Phone Number?
              </h4>
              <div className="bg-white mt-8 md:mt-4 flex items-center w-[84%] rounded-[20px] h-[74px] md:h-[60px] md:rounded-[10px] border-2 border-white">
                <div className="phonenumber--text md:text-[20px] gap-2 pl-4 w-[120px] border-r-[2px] border-[#7E7E7E]">
                  +91{" "}
                  <svg
                    className="md:w-[13px]"
                    width="17"
              ...
              <p className="paragraph--text  md:text-[16px] md:pt-5 md:leading-[24px]  pt-6 w-[88%] md:w-[80%]">
              ...
              <Link href="otp" className="md:w-[84%]">
                <div className="bg-white justify-center md:h-[60px] mt-8 flex items-center w-[84%] md:w-[100%] cursor-pointer rounded-[20px] h-[74px] md:rounded-[10px] md:mt-5 border-2 gap-2 border-white">
              ...
              <div className="md:flex md:items-center md:justify-center md:flex-col">
                <p className="paragraph--text w-[100%] text-center flex items-center justify-center pr-[130px] md:pr-9 pt-6 md:pt-4 md:w-[120%]">
                  ...
                  <span className="text-[700] text-[25px] pl-2"> Login</span>
                </p>
